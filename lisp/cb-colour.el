...
(cb:define-theme ir-black
  ...
  (let* ((class '((class color) (min-colors 89)))
         ...
         (solarized-fg-hc base03)
         (solarized-fg-lc base3)
    ...
    (custom-theme-set-faces
     ...
     `(font-lock-doc-string-face ((,class (:slant italic))))
...
;;; external
     ...
     `(helm-buffer-saved-out ((,class (:foreground ,red :inverse-video t))))
     ...
     `(helm-selection ((,class (:background ,solarized-hl :underline nil))))
     ...
     ;; paren-face-plus
     `(paren-face  ((,class (:foreground "grey20"))))
     ...
     `(w3m-image ((,class (:background ,solarized-fg :foreground "black"))))
