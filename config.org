...
(defun cb-org:goto-or-create-work-log ()
  ...
  (if (search-backward-regexp (rx bol "* Work Log") nil t)
      (end-of-line)
      ...
      (->> '(("A" "Agenda and next actions"
             ...
             ("W" "Agenda and work actions"
              ...
              ((org-agenda-tag-filter-preset '("+@work"))
               (org-agenda-hide-tags-regexp
                (regexp-opt (list org-agenda-hide-tags-regexp
                                  "@work"
                                  "rpm")))))
             ...
             ("w" "Weekly Review"
              ((agenda "" ((org-agenda-ndays 7)))
               (stuck "")
               (todo "WAITING")
               (tags-todo "someday-media-skill/MAYBE|NEXT")
...
(setq org-todo-keywords
      '((sequence "READY(r)" "|" "COLLECTED(c!)" "CANCELLED(k@)")
        (sequence "CALLBACK" "MESSAGE" "|" "TRANSFERRED" "HANDLED(h@)")
        (type "MAYBE(m!)")
        (sequence "OUTSTANDING(o)" "|" "PAID(p!)" "VOID(v@)")
        (sequence "TODO(t)" "NEXT(n!)" "WAITING(w@/!)" "APPT(a!)"
