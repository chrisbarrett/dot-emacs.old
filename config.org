...
#+begin_src emacs-lisp
(autoload 'org-compose-mail "cb-org-mail")
(autoload 'org-compose-mail-subtree "cb-org-mail")
...
(-each `(("t" "Todo" entry
         ...
         ("p" "Phone Call (in)" entry
          ...
          ,(s-unlines
            ...
            ":LOGBOOK:"
            ":END:"
            "- From :: %(cb-org:read-caller)"
            "- To :: %(cb-org:read-caller)"
            "- Subject :: %^{Subject}"
            "- Action :: "
            "** Notes"
            "%?")
...
#+begin_src emacs-lisp
(setq org-agenda-hide-tags-regexp "someday")
#+end_src
*** Define agenda views
...
(setq org-agenda-custom-commands
      (->> '(("A" "Agenda and next actions"
              ...
              ((org-agenda-tag-filter-preset (when cb-org:at-work?
                                               '("-drill")))))
