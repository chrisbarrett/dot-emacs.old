...
#+begin_src emacs-lisp
(bind-key "S-<tab>" 'shm/simple-indent-backtab shm-map)
(bind-key "<tab>" 'shm/simple-indent shm-map)
#+end_src
...
(defun cbhs:smart-pipe ()
  ...
  (interactive)
  (cond
   ((or (cb-hs:in-string?) (cb-hs:in-comment?))
    (insert "|"))
...
With a prefix arg, insert a period without padding."
  (interactive "*P")
  (cond
   ((or arg (cb-hs:in-string?) (cb-hs:in-comment?))
    (insert "."))
