...
(flycheck-define-checker idris
  ...
  :command ("idris" "--check" "--nocolour" "--warnpartial" source)
  :error-patterns
...
(defun cbidris:flycheck-setup ()
  (flycheck-mode +1)
  (flycheck-select-checker 'idris))

(add-hook 'idris-mode-hook 'cbidris:flycheck-setup)
#+end_src
