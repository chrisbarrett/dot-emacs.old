...
(define-key haskell-mode-map (kbd "-") 'cbhs:smart-minus)
(define-key haskell-mode-map (kbd ".") 'cbhs:smart-dot)
(define-key haskell-mode-map (kbd "|") 'cbhs:smart-pipe)
(define-key haskell-mode-map (kbd "#") 'cbhs:smart-hash)

(declare-smart-ops 'inferior-haskell-mode :add '("." "$" "," "="))

(define-key inferior-haskell-mode-map (kbd "-") 'cbhs:smart-minus)
(define-key inferior-haskell-mode-map (kbd ".") 'cbhs:smart-dot)
(define-key inferior-haskell-mode-map (kbd "|") 'cbhs:smart-pipe)
