...
(defun cb-hs:set-up-smart-ops ()
  ...
  (smart-insert-operator-hook)
  (local-set-key (kbd "-") 'cbhs:smart-minus)
  (local-set-key (kbd "=") (command (smart-insert-operator "=")))
  (local-set-key (kbd "<") 'cbhs:smart-lt)
  (local-set-key (kbd ".") 'cbhs:smart-dot)
  (local-set-key (kbd "|") 'cbhs:smart-pipe)
  (local-set-key (kbd "?") (command (smart-insert-operator "?")))
  (local-set-key (kbd "$") (command (smart-insert-operator "$"))))

(add-hook 'cb:haskell-modes-hook 'cb-hs:set-up-smart-ops)
#+end_src
** hideshow
*** Define helper functions
#+begin_src emacs-lisp
